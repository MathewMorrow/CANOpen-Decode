...
% File constants
endOfHeaderStr = ";---+--   ----+----  --+--  ----+---  +  -+ -- -- -- -- -- -- --";
canData = struct('msgNumber', zeros(1,CAN_DATA_SIZE),'TimeMs', zeros(1,CAN_DATA_SIZE),'Typemsg', zeros(1,CAN_DATA_SIZE),'length', zeros(1,CAN_DATA_SIZE),'ID', zeros(1,CAN_DATA_SIZE),'dataBytes', zeros(8,CAN_DATA_SIZE) );
%canData = canData_t;
